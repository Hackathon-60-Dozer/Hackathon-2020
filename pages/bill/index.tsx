  ...
  return (
    <Layout maxWidth={'xl'} style={{ padding: 0 }} className={styles.root}>
      ...
      <Section color={'grey'}>
        <div className={styles.adressContainer}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <Typography
              ...
              color={'secondary'}
              style={{ marginLeft: 20 }}>
              Vous devrez entrer vos informations de connexion pour passer votre
              commande
            </Typography>
          </div>
        ...
        <div className={styles.adressContainer} style={{ marginTop: 30 }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <Typography
              ...
              style={{ marginLeft: 20 }}>
              John Doe{' '}
              <span style={{ marginLeft: 50, fontWeight: 'bold' }}>
                Exp: 09/22
              </span>
            </Typography>
          </div>
        ...
        <div className={styles.adressContainer}>
          <Input
            style={{
              background: '#fafafa',
              boxShadow: '0 0 4px 0 rgba(0,0,0,0.30',
              padding: 5,
              borderRadius: 2,
              width: '50%',
            }}
          ...
          <Input
            ...
            placeholder={'NOM APPARAISSANT SUR LA CARTE'}
          />
          <Typography
            variant={'h5'}
            color={'secondary'}
      ...
      <Section color={'white'}>
        ...
        <Link href={routes.billSuccess.url} passHref>
          <Button
            variant={'contained'}
            color={'secondary'}
            style={{ margin: 30 }}>
