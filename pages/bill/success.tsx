  ...
  return (
    <Layout maxWidth={'xl'} style={{ padding: 0 }}>
      ...
      <Typography
        ...
        Nous vous confirmons que la commande a bien été prise en compte et
        qu'elle est en cours de préparation.
      </Typography>
      <div
        style={{
          width: '70%',
        ...
        <Typography variant={'h5'} color={'textSecondary'} style={{}}>
          COMMANDE N°8E869F0F-B8E4-488A
        </Typography>
        <Typography variant={'h5'} color={'textPrimary'} style={{}}>
          Passée le 10 décembre 2021 à 14h45
        </Typography>
        <Typography variant={'h5'} color={'textSecondary'} style={{}}>
      ...
      <div style={{ marginTop: 50, width: '50%' }}>
        ...
        <Typography
          variant={'body1'}
          color={'primary'}
          style={{ textAlign: 'center', fontSize: 17, margin: 50 }}>
          Un doute sur un produit ? Consultez notre page sur les allergènes{' '}
          <a href="">ici</a>
        </Typography>
